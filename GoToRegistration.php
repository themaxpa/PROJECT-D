...
<section>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center" style="background-image: url('./assets/img/project-img/f1meter.jpg'); background-size: cover; height:80vh">
